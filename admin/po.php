      ...
      <ol class="breadcrumb">
		<li>
			<a href="#" class="small-box-footer">
				...
				<span class="fa fa-plus-square-o"></span> Tambah Data G Number</button>
			</a>	
		</li>
      </ol>
    </section>
				...
				<?php
					...
					<td>
						<center>
							...
							<a href='delete/po.php?pro_no=$data[pro_no]' class='btn btn-danger btn-xs' onClick='return hapus()'title='Hapus Data'>
								<span class='fa fa-trash-o'></span></a>
							<a href='e-po.php?pro_no=$data[pro_no]' class='btn btn-warning btn-xs' title='Edit Data'>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
					<form name='input' method='POST' action='save/s-po.php' class='form-horizontal'>
					<div class="form-group">
						<label class="col-sm-3 control-label">No</label>
							<div class="col-sm-5">
						<input type='text' name='pro_no' placeholder='No' class='form-control' autocomplete='off' required maxlength='50'>
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">PO</label>
							<div class="col-sm-5">
						<input type='text' name='ponum' placeholder='PO' class='form-control' autocomplete='off' required maxlength='50'>
					</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Customer</label>
							<div class="col-sm-5">
						<input type='text' name='cust' placeholder='Customer' class='form-control' autocomplete='off' required maxlength='50'>
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">Project</label>
							<div class="col-sm-5">
						<input type='text' name='nm_pro' placeholder='Project' class='form-control' autocomplete='off' required maxlength='50'>
					</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Status</label>
							<div class="col-sm-5">
						<input type='text' name='stat' placeholder='Status' class='form-control' autocomplete='off' required maxlength='50'>
					</div>
					</div>
              </div>
